            ...
            <div class="section">
                <div class="section-header d-flex justify-content-between align-items-center mb-2">
                    ...
                    <div class="section-header-breadcrumb">
                        ...
                        <div class="breadcrumb-item">Brosur</div>
                    </div>
                </div>
            </div>
            <div class="card">
                <h3 class="text-center my-4 text-dark">
                    <span class="border-bottom border-primary">Brosur</span>
                </h3>
                <div class="card-body">
                ...
                <div class="card-body">
                    @if ($brosur->isEmpty())
                        <p class="text-center">Tidak ada Brosur tersedia.</p>
                    @else
                                        ...
                                        <div class="card-body d-flex flex-column justify-content-between"
                                            ...
                                            <div>
                                                ...
                                                <div class="text-center mt-3">
                                                    <a href="{{ route('brosur.show', $item->id) }}"
                    ...
                    <div class="d-flex justify-content-center">
                        <nav>
                            {{ $brosur->links('pagination::bootstrap-4') }}
                        </nav>
                    </div>
                </div>
            </div>
