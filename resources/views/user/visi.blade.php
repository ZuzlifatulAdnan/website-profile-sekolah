                ...
                <div class="section-body">
                    <div class="section-header d-flex justify-content-between align-items-center mb-2">
                        ...
                        <div class="section-header-breadcrumb">
                            ...
                            <div class="breadcrumb-item active">Visi dan Misi</div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title"><span class="border-bottom border-primary">Visi</span></h5>
                                    <p>
                                        {!! html_entity_decode($misi->deskripsi) !!}
                                    </p>

                                    <h5 class="card-title"><span class="border-bottom border-primary">Misi</span></h5>
                                    <p>
