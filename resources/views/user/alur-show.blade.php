            ...
            <div class="section">
                <div class="section-header d-flex justify-content-between align-items-center mb-2">
                    ...
                    <div class="section-header-breadcrumb">
                        ...
                        <div class="breadcrumb-item active"><a href="{{ route('alur') }}">Alur</a></div>
                        <div class="breadcrumb-item">{{ $alur->judul }}</div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h3 class="text-center text-dark mb-4">
                                    <span class="border-bottom border-primary">{{ $alur->judul }}</span>
                                </h3>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        @if ($alur->image)
                                            ...
                                            <img src="{{ asset('storage/' . $alur->image) }}" alt="{{ $alur->judul }}"
                                ...
                                <div class="row mb-4">
                                    <div class="col-12 d-flex justify-content-between flex-wrap">
                                        <span class="text-muted">
                                            ...
                                            {{ $alur->created_at ? $alur->created_at->format('d M Y') : 'Date Not Available' }}
                                        </span>
                                        <span class="text-muted">
                                            <i class="fas fa-user"></i>
                                            {{ $alur->users->name ?? 'Unknown Author' }}
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-12">
                                        <p> {!! html_entity_decode($alur->deskripsi) !!}</p>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12 text-center text-md-left">
                                        <a href="{{ route('alur') }}" class="btn btn-primary">Kembali ke Daftar Alur</a>
                                    </div>
                                </div>
                            </div>
                        </div>
