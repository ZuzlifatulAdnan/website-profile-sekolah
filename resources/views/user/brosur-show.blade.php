            ...
            <div class="section">
                <div class="section-header d-flex justify-content-between align-items-center mb-2">
                    ...
                    <div class="section-header-breadcrumb">
                        ...
                        <div class="breadcrumb-item active"><a href="{{ route('brosur') }}">Brosur</a></div>
                        <div class="breadcrumb-item">{{ $brosur->judul }}</div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h3 class="text-center text-dark mb-4">
                                    <span class="border-bottom border-primary">{{ $brosur->judul }}</span>
                                </h3>
                                ...
                                <div class="row mb-4">
                                    <div class="col-12 d-flex justify-content-between flex-wrap">
                                        <span class="text-muted">
                                            ...
                                            {{ $brosur->created_at ? $brosur->created_at->format('d M Y') : 'Date Not Available' }}
                                        </span>
                                        <span class="text-muted">
                                            <i class="fas fa-user"></i>
                                            {{ $brosur->users->name ?? 'Unknown Author' }}
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-12">
                                        <p> {!! html_entity_decode($brosur->deskripsi) !!}</p>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12 text-center text-md-left">
                                        <a href="{{ route('brosur') }}" class="btn btn-primary">Kembali ke Daftar Brosur</a>
                                    </div>
                                </div>
                            </div>
                        </div>
